...
const AdminDashboard = () => {
  ...
  // create a hook that will contain all the response give by the endpoint admin admin stats
  ...
  // by using useEffect hook, we shall authomatically invoke a function fetchstats()
  ...
  const fetchStats = async () =>{
      ...
      try{
        const res = await axios.get("https://kindergartenapi.onrender.com/api/dashboarAdmin", {
          headers: {
